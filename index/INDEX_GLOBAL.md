...
| `viralefy_front` | TypeScript (Next.js) | frontend | 145 | 584 | 584 | ✅ | 440 |
...
- **Índice de funções:** [`INDEX_FUNCTIONS_viralefy_front.md`](INDEX_FUNCTIONS_viralefy_front.md) — 584 entradas
- **Pastas top-level:**

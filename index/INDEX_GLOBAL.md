...
| `viralefy_front` | TypeScript (Next.js) | frontend | 149 | 593 | 593 | ✅ | 441 |
...
- **Índice de funções:** [`INDEX_FUNCTIONS_viralefy_front.md`](INDEX_FUNCTIONS_viralefy_front.md) — 593 entradas
- **Pastas top-level:**
